...
export default function EPFONav({ currentView, onNavigate, lang }) {
  ...
  return (
    <nav
      ref={navRef}
      className="bg-[#048282] text-white px-4 shadow-md relative z-40"
    >
            ...
            {item.children ? (
              <>
                ...
                >
                  ...
                  <ChevronDown
                    className={`w-3.5 h-3.5 transition-transform ${openMenu === item.id ? "rotate-180" : ""}`}
                  />
                </button>
                {openMenu === item.id && (
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-2.5 text-[13px] font-medium hover:bg-[#048282]/10 hover:text-[#048282] transition-colors flex items-center justify-between ${
                          currentView === child.id
                            ? "bg-[#048282]/10 text-[#048282] font-bold"
                            : ""
                        }`}
                      >
