          ...
          <div className="bg-white border-l-4 border-red-600 shadow-sm rounded-r-lg p-4 flex items-start space-x-3">
            ...
            <div>
              <h3 className="text-red-600 font-bold text-lg mb-1">
                {t("Important Cyber Security Alert for EPF Members", lang)}
              </h3>
              <p className="text-gray-700 text-sm">
                {t(
                  "Please be vigilant against credential theft. EPFO never asks for personal details like Aadhaar, PAN, UAN, Password, or OTP over phone, social media, or WhatsApp. Do not share your login credentials with anyone.",
                  lang,
                )}
              </p>
            </div>
          ...
          <div className="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
            <div className="bg-[#048282] px-4 py-3 flex items-center text-white">
              ...
              <h3 className="font-semibold text-lg">
                {t("Dear EPF Members !! Notices & Circulars", lang)}
              </h3>
              <span className="ml-auto bg-red-600 text-xs px-2 py-1 rounded animate-pulse font-bold tracking-wider">
                LATEST
              </span>
            </div>
            <div className="p-4 space-y-4">
              <ul className="space-y-4 text-sm text-gray-800">
                <li className="flex items-start">
                  ...
                  <span>
                    {t(
                      "UAN activation and new UAN generation can now be done through Face Authentication on UMANG app.",
                      lang,
                    )}
                  </span>
                </li>
                <li className="flex items-start">
                  <ChevronRight
                    className="text-[#048282] mr-2 flex-shrink-0 mt-0.5"
                    size={18}
                  />
                ...
                <li className="flex items-start">
                  ...
                  <span className="flex-1">
                    {t(
                      "Important notice about EDLI (Employees Deposit Linked Insurance Scheme).",
                      lang,
                    )}
                  </span>
                </li>
                <li className="flex items-start">
                  ...
                  <span>
                    {t(
                      "Filing of e-Nominations by members is mandatory as per EPF Scheme, 2026. E-Nominations can be filed and updated during service period.",
                      lang,
                    )}
                  </span>
                </li>
                <li className="flex items-start bg-teal-50 p-3 rounded border border-teal-100">
                  <Shield
                    ...
                    size={18}
                  />
                  <span className="font-semibold text-[#048282]">
                    {t(
                      "Members can now file Online Claims (Form 31 Advance) with offline resilience - claims are preserved locally even if the server is unreachable.",
                      lang,
                    )}
                  </span>
                </li>
          ...
          <div className="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
            <div className="p-4 border-b border-gray-100 bg-gray-50">
              <h3 className="text-xl font-bold text-gray-800 mb-4">
                {t("Quick Services", lang)}
              </h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
              <div
                className="border border-gray-200 rounded p-4 hover:shadow-md transition-shadow cursor-pointer group flex flex-col justify-between"
                onClick={() =>
                  alert(
                    "This quick service has been temporarily disabled for maintenance. Please login to use full features.",
                  )
                }
              >
                ...
                <p className="text-xs text-gray-600 flex-1">
                  {t("Activate your UAN to access EPF services online", lang)}
                </p>
                <div className="mt-3 flex justify-end">
                  <ArrowRight
                    size={16}
                    className="text-[#048282] opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-1"
                  />
                </div>
              </div>
              ...
              >
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-semibold text-gray-800">
                    {t("Track Application Status", lang)}
                  </h4>
                </div>
                <p className="text-xs text-gray-600 flex-1">
                  {t("Check the progress of your application", lang)}
                </p>
                <div className="mt-3 flex justify-end">
                  <ArrowRight
                    size={16}
                    className="text-blue-600 opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-1"
                  />
                </div>
              </div>
              ...
              >
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-semibold text-gray-800">
                    {t("Know Your UAN", lang)}
                  </h4>
                </div>
                <p className="text-xs text-gray-600 flex-1">
                  {t("Retrieve your UAN using basic details", lang)}
                </p>
                <div className="mt-3 flex justify-end">
                  <ArrowRight
                    size={16}
                    className="text-green-600 opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-1"
                  />
                </div>
              </div>
              ...
              >
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-semibold text-gray-800">
                    {t("Direct UAN Allotment", lang)}
                  </h4>
                </div>
                <p className="text-xs text-gray-600 flex-1">
                  {t("Self-generate your UAN without employer", lang)}
                </p>
                <div className="mt-3 flex justify-end">
                  <ArrowRight
                    size={16}
              ...
              >
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-semibold text-gray-800">
                    {t("UAN for Existing PF", lang)}
                  </h4>
                </div>
                <p className="text-xs text-gray-600 flex-1">
                  {t("Generate UAN for members with active PF", lang)}
                </p>
                <div className="mt-3 flex justify-end">
                  <ArrowRight
                    size={16}
                    className="text-purple-600 opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-1"
                  />
                </div>
              </div>
              ...
              >
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-semibold text-gray-800">
                    {t("Death Claim Filing", lang)}
                  </h4>
                </div>
                <p className="text-xs text-gray-600 flex-1">
                  {t("Nominee claim filing under EDLI scheme", lang)}
                </p>
                <div className="mt-3 flex justify-end">
                  <ArrowRight
                    size={16}
                    className="text-orange-500 opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-1"
                  />
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
            <div className="p-6 pb-4 flex flex-col items-center border-b border-gray-100">
              ...
              <h2 className="text-xl font-bold text-gray-800 text-center">
                {t("Member e-Sewa Login", lang)}
              </h2>
              <p className="text-sm text-gray-500 text-center mt-1">
                {t("Universal Account Number Portal", lang)}
              </p>
            </div>

            <div className="p-4 bg-gray-50 border-b border-gray-100">
              <p className="text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wider">
                {t("Quick Access — Test Profiles:", lang)}
              </p>
              <div className="grid grid-cols-2 gap-2">
                ...
                >
                  <span className="font-semibold text-sm text-gray-800 block truncate w-full">
                    Ramesh Kumar
                  </span>
            ...
            <div className="p-6">
              <form onSubmit={handleLoginSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    value={loginUan}
                    onChange={(e) =>
                      setLoginUan(e.target.value.replace(/[^0-9]/g, ""))
                    }
                    maxLength={12}
                ...
                <div>
                  ...
                  <div className="flex gap-2 mb-2">
                    ...
                    <button
                      type="button"
                      className="bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded px-3 text-gray-600 transition-colors"
                    >
                      <RefreshCw size={18} />
                    </button>
                  </div>
                ...
                <div className="pt-2 space-y-3">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      handlePasskeyLogin(loginUan || "101294829101")
                    }
                    disabled={isAuthenticating}
                  ...
                  >
                    ...
                    <span>
                      {isAuthenticating
                        ? "Authenticating..."
                        : t("Verify with Device (Passkey)", lang)}
                    </span>
                  </button>
                </div>
              </form>
              ...
              <div className="mt-6 text-center">
                <a
                  href="#"
                  className="text-sm text-[#048282] hover:text-[#036666] font-medium hover:underline"
                >
